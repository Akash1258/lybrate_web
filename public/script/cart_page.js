    ...
    function removefrom(product) {
        // window.location.href=`http://localhost:3000/products/cart/remove/${product}`
    }
    ...
    function showOrderSummary() {
        ...
        cart_page_arr.forEach(function (product) {
            ...
            //set payable ammount to localstorage
            localStorage.setItem('payable', JSON.stringify({ price: product.cart_total_price }))
    ...
    function btnDiv() {
        ...
        proceedToBuy.onclick = function () {
            var data_div = document.getElementById("detais_of_product");
            data_div.style.display = "none"
            let address = document.getElementById("addresscontainer1")
    ...
    function plus(a) {
        ...
        let final_ammount = { price: temp - tempDiscount }

        localStorage.setItem('payable', JSON.stringify(final_ammount))
    }
    ...
    function allitemadded() {
            let Name = document.getElementById('name').value;
            let phone = document.getElementById('phone').value;
            let City = document.getElementById('city').value;
            let code = document.getElementById('code').value;
            let adr = document.getElementById('adinput').value;


            if (Name === "" || phone === "" || City === "" || phone.length !== 10 || code === "" || code.length !== 6 || adr === "" || adr.length < 14) {
                ...
                window.location.href = "/products/cart/checkout/buyfromcart"
            }
    }